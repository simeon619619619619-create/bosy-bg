  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          background: 'linear-gradient(135deg, #c77dba 0%, #4e871f 100%)',
          color: '#fff',
          padding: '60px 30px',
        }}
      >
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            >
              ...
              <a
                ...
                className="flex items-center gap-2.5 py-2 text-sm transition-colors hover:text-[#c77dba]"
            ...
            >
              ...
              <a
                ...
                className="block py-2 text-sm transition-colors hover:text-[#c77dba]"
                style={{ color: '#555', borderBottom: '1px solid #f0f0f0' }}
              >
                sales@bosy.bg
            ...
            <form>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-lg text-sm outline-none transition-colors focus:border-[#c77dba] focus:bg-white"
                    style={{
                      padding: '14px 16px',
              ...
              <div className="mb-5">
                ...
                <textarea
                  ...
                  rows={5}
                  className="w-full rounded-lg text-sm outline-none transition-colors resize-y focus:border-[#c77dba] focus:bg-white"
                  style={{
                    padding: '14px 16px',
                    border: '2px solid #e8e8e8',
                    background: '#fafafa',
