        ...
        <div className="grid gap-10 mb-10 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              <Link href="/about" className="text-[13px] transition-colors duration-200 hover:text-[#c77dba]" style={{ color: '#aaa' }}>За нас</Link>
              <Link href="/contacts" className="text-[13px] transition-colors duration-200 hover:text-[#c77dba]" style={{ color: '#aaa' }}>Контакти</Link>
              <Link href="/shop" className="text-[13px] transition-colors duration-200 hover:text-[#c77dba]" style={{ color: '#aaa' }}>Магазин</Link>
              <Link href="/bosy-club" className="text-[13px] transition-colors duration-200 hover:text-[#c77dba]" style={{ color: '#aaa' }}>BOSY Club</Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              <Link href="/privacy-policy" className="text-[13px] transition-colors duration-200 hover:text-[#c77dba]" style={{ color: '#aaa' }}>Условия за ползване</Link>
              <Link href="/cookies" className="text-[13px] transition-colors duration-200 hover:text-[#c77dba]" style={{ color: '#aaa' }}>Cookie Policy</Link>
              <Link href="/blog" className="text-[13px] transition-colors duration-200 hover:text-[#c77dba]" style={{ color: '#aaa' }}>Блог</Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              <a href="tel:+359887808808" className="text-[13px] transition-colors duration-200 hover:text-[#c77dba]" style={{ color: '#aaa' }}>+359 887 808 808</a>
              <a href="tel:+359879898988" className="text-[13px] transition-colors duration-200 hover:text-[#c77dba]" style={{ color: '#aaa' }}>+359 879 898 988</a>
              <a href="mailto:sales@bosy.bg" className="text-[13px] transition-colors duration-200 hover:text-[#c77dba]" style={{ color: '#aaa' }}>sales@bosy.bg</a>
            </div>
          </div>
        </div>
